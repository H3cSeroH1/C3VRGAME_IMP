...
namespace Valve.VR.InteractionSystem
{
    public class CustomHandPhysics : MonoBehaviour
    {
        ...
        public GameObject handcParentPlayer = null;
        ...
        private void Start()
        {
            ...
            handCollider.transform.parent = handcParentPlayer.transform;
        ...
        private void UpdatePositions()
        {
            ...
            else
            {
                ...
                if (!collisionsEnabled)
                {
                    ...
                    Physics.OverlapSphereNonAlloc(hand.GrabPoint(), collisionReenableClearanceRadius, clearanceBuffer);
